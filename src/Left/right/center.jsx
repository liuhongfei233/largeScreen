...
const Center = () => {
  ...
  const getContent = useMemo(() => {
    if (data?.jyscw == 0) return "上超";
    if (data?.jysxw) return "上限";
    if (data?.jysjw) return "上减";
    if (data?.jyxjw) return "下减";
    if (data?.jyxxw) return "下限";
  ...
  return (
    <div className="yao">
      ...
      <div className="liangdou">
        <Dou
          shou={
            data["1ylczdgljyx"] || data["2ylczdgljyx"] || data["3ylczdgljyx"]
          }
          open={data?.cldzmkdw}
          data={data?.cldzlfk}
      ...
      <div className="yao_bottom_right">
        ...
        <TR content={data?.mqzgll} alarm={data?.mqzgll_alarm} unit="m3/h" />
      </div>
      <div className="yao_right_bottom">
        <div style={{ marginRight: 10 }}>
          ...
          <TR content={data?.gwfjzs} alarm={data?.gwfjzs_alarm} unit="rpm" />
        </div>
        <div>
